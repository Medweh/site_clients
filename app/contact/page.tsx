...
export default function ContactPage() {
  ...
  return (
    <div className="relative py-12 md:py-20 px-4 sm:px-6 lg:px-8 max-w-7xl mx-auto">
      ...
      <div className="absolute top-20 right-10 w-96 h-96 bg-[#002FA7]/5 rounded-full blur-3xl pointer-events-none -z-10" />
      ...
      <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 items-start">
        ...
        <div className="lg:col-span-5 space-y-8">
          ...
          <div className="space-y-5">
            {/* Item 1 */}
            <div className="flex items-start space-x-4 p-4 rounded-xl bg-white/80 border border-slate-200/60 shadow-sm">
              <div className="w-10 h-10 rounded-lg bg-[#002FA7]/10 text-[#002FA7] flex items-center justify-center shrink-0 border border-[#002FA7]/20">
                <Clock className="h-5 w-5" />
              </div>
              <div>
                <h3 className="font-bold text-slate-900 text-sm">Réactivité Garantie</h3>
            ...
            {/* Item 2 */}
            <div className="flex items-start space-x-4 p-4 rounded-xl bg-white/80 border border-slate-200/60 shadow-sm">
              <div className="w-10 h-10 rounded-lg bg-[#0F766E]/10 text-[#0F766E] flex items-center justify-center shrink-0 border border-[#0F766E]/20">
                <ShieldCheck className="h-5 w-5" />
              </div>
              <div>
                <h3 className="font-bold text-slate-900 text-sm">Confidentialité Totale</h3>
                <p className="text-xs text-slate-600 leading-relaxed mt-0.5">
            ...
            <div className="glass-panel bg-white/70 rounded-2xl p-6 border-slate-200/60 shadow-sm space-y-4">
              <h3 className="font-bold text-slate-900 text-sm">Canaux Directs</h3>
              <div className="space-y-3">
                <a
                  href="mailto:med.essahafi@gmail.com"
                  className="flex items-center space-x-3 text-xs text-slate-600 hover:text-[#002FA7] transition-colors"
                >
                ...
                <a
                  ...
                  className="flex items-center space-x-3 text-xs text-slate-600 hover:text-[#25D366] transition-colors"
                >
